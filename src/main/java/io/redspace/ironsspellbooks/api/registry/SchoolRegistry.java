...
public class SchoolRegistry {
    ...
    public static final Registry<SchoolType> REGISTRY = SCHOOLS.makeRegistry(builder -> {
    });
    ...
    private static DeferredHolder<SchoolType, SchoolType> registerSchool(SchoolType schoolType) {
    ...
    public static final DeferredHolder<SchoolType, SchoolType> FIRE = registerSchool(new SchoolType(
            FIRE_RESOURCE,
            ModTags.FIRE_FOCUS,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> ICE = registerSchool(new SchoolType(
            ICE_RESOURCE,
            ModTags.ICE_FOCUS,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> LIGHTNING = registerSchool(new SchoolType(
            LIGHTNING_RESOURCE,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> HOLY = registerSchool(new SchoolType(
            HOLY_RESOURCE,
            ModTags.HOLY_FOCUS,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> ENDER = registerSchool(new SchoolType(
            ENDER_RESOURCE,
            ModTags.ENDER_FOCUS,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> BLOOD = registerSchool(new SchoolType(
            BLOOD_RESOURCE,
            ModTags.BLOOD_FOCUS,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> EVOCATION = registerSchool(new SchoolType(
            EVOCATION_RESOURCE,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> NATURE = registerSchool(new SchoolType(
            NATURE_RESOURCE,
    ...
    public static final DeferredHolder<SchoolType, SchoolType> ELDRITCH = registerSchool(new SchoolType(
            ELDRITCH_RESOURCE,
