...
@EventBusSubscriber(modid = IronsSpellbooks.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_MANA = ATTRIBUTES.register("max_mana", () -> (new MagicRangedAttribute("attribute.irons_spellbooks.max_mana", 100.0D, 0.0D, 10000.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MANA_REGEN = ATTRIBUTES.register("mana_regen", () -> (new MagicRangedAttribute("attribute.irons_spellbooks.mana_regen", 1.0D, 0.0D, 10.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> COOLDOWN_REDUCTION = ATTRIBUTES.register("cooldown_reduction", () -> (new MagicRangedAttribute("attribute.irons_spellbooks.cooldown_reduction", 1.0D, -10.0D, 10.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SPELL_POWER = ATTRIBUTES.register("spell_power", () -> (new MagicRangedAttribute("attribute.irons_spellbooks.spell_power", 1.0D, 0, 10.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SPELL_RESIST = ATTRIBUTES.register("spell_resist", () -> (new MagicRangedAttribute("attribute.irons_spellbooks.spell_resist", 1.0D, 0, 10.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> CAST_TIME_REDUCTION = ATTRIBUTES.register("cast_time_reduction", () -> (new MagicRangedAttribute("attribute.irons_spellbooks.cast_time_reduction", 1.0D, 0, 10.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> SUMMON_DAMAGE = ATTRIBUTES.register("summon_damage", () -> (new MagicRangedAttribute("attribute.irons_spellbooks.summon_damage", 1.0D, 0, 10.0D).setSyncable(true)));
